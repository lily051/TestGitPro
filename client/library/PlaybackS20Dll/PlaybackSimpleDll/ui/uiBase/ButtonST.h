...
{
	DECLARE_DYNAMIC(CButtonST)//gll090113
...
public:
	CFont		*m_pFontText;       // yxn20091224
	void		SetTextFont(CFont *pFont){m_pFontText = pFont;}  // yxn20091224
	...
	DWORD SetBtnCursor(HCURSOR hCursor, BOOL bRepaint = TRUE);
...
#endif
	afx_msg void OnRButtonDown(UINT nFlags, CPoint point) ;//gll
