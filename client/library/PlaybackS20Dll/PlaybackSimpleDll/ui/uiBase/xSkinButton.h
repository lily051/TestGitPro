...
public:
	...
	void SetNormal(HBITMAP hNormal);
	void SetSkinBitmap(HBITMAP hNormal, HBITMAP hDown, HBITMAP hHover, HBITMAP hDisable = NULL);
	...
	HICON m_hNormalIcon;		//Õý³£Í¼±ê
	HICON m_hDisableIcon;
	void SetIcon(UINT uNormal);
