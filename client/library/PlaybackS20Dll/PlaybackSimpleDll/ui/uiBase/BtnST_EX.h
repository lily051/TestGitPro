...
class CButtonST_EX : public CButton
{
	DECLARE_DYNCREATE(CButtonST_EX) 
public:
    CButtonST_EX();
	~CButtonST_EX();
...
public:
	...
	DWORD SetBitmaps(int nBitmapIn, COLORREF crTransColorIn, int nBitmapOut = NULL, COLORREF crTransColorOut = 0,int nBitmapDown=NULL, COLORREF crTransColorDown=0);
	DWORD SetBitmaps(HBITMAP hBitmapIn, COLORREF crTransColorIn, HBITMAP hBitmapOut = NULL, COLORREF crTransColorOut = 0,HBITMAP hBitmapDown = NULL, COLORREF crTransColorDown=0);
