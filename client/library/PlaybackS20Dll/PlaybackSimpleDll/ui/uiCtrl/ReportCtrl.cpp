...
//////////////////////////////////////////////////////////////////////////
// CColorHeader
IMPLEMENT_DYNAMIC(CColorHeader, CHeaderCtrl)
...
void CColorHeader::OnPaint()
{
	...
	CRect rect;
	GetClientRect(rect);
	dc.FillSolidRect(rect, UI_LISTHEADER_COLOR);   //重绘标题栏颜色
	...
	CFont m_font;
	m_font.CreatePointFont(90,_T("宋体"));        //字体
	CFont * pOldFont=dc.SelectObject(&m_font);

	dc.SetTextColor(RGB(0,0,0));     //字体颜色
...
void CReportCtrl::PreSubclassWindow() 
{
	...
	if (pHeaderCtrl)
	{
		m_colorHeader.SubclassWindow(pHeaderCtrl->m_hWnd);
	}
