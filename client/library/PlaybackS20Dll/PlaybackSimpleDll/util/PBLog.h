...
#define PB_OBJECT_NAME             "PlaybackSimpleDLL"
...
#define PLAYBACKDLL_ERROR(fmt, ...) PB_PRINT(HLOG_LEVEL_ERROR, __FILE__, __LINE__, __FUNCTION__, fmt, ##__VA_ARGS__)
#define PLAYBACKDLL_INFO(fmt, ...) PB_PRINT(HLOG_LEVEL_INFO, __FILE__, __LINE__, __FUNCTION__, fmt, ##__VA_ARGS__)
#define PLAYBACKDLL_WARN(fmt, ...) PB_PRINT(HLOG_LEVEL_WARN, __FILE__, __LINE__, __FUNCTION__, fmt, ##__VA_ARGS__)
#define PLAYBACKDLL_DEBUG(fmt, ...) PB_PRINT(HLOG_LEVEL_DEBUG, __FILE__, __LINE__, __FUNCTION__, fmt, ##_VA_ARGS__)
// MYLOG LOGGER
