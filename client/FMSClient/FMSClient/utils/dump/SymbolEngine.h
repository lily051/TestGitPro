...
public      :
	...
	/***********************
	Function Name:SymInitialize
	Description:init the symbol table
	input:hProcess --current process handle
	      UserSearchPath--symbol table path
		  fInvadeProcess--process callback
	...
	***********************/
	...
	/***********************
	Function Name:SymCleanup
	Description:Release the symbol table
	input: NULL
...
public      :
	...
	/***********************
	Function Name:SymEnumerateModules
	Description:Enumerate all modules in the symbol table
	input: EnumModulesCallback--callback to Enumerate the modules in the symbol table
		   UserContext--
