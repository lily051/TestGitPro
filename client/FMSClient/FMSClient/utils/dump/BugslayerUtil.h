...
JUN '01 - Added NEW_INLINE_WORKAROUND at the bottom of this file to 
...
DEC '01 - Fixed a bug in CrashHandler.CPP pointed out by 
          Gennady Mayko.
...
// Fix the Debug C Run Time to work properly!
//#ifdef _DEBUG 
#if 0
