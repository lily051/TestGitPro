...
class CClientSessionMgr : public singleton<CClientSessionMgr>
{

public:
	CClientSessionMgr(void);
	virtual ~CClientSessionMgr(void);
public:
    /**	@fn	    Init
    *	@brief	初始化函数
...
inline CClientSessionMgr* GetClientSessionMgrPtr(void)
{
	return CClientSessionMgr::instance();
}
