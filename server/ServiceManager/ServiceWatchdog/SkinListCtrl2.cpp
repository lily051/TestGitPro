...
IMPLEMENT_DYNAMIC(CSkinListCtrl2, CListCtrl)
...
BEGIN_MESSAGE_MAP(CSkinListCtrl2, CListCtrl)
    ...
    ON_NOTIFY_REFLECT(NM_RCLICK, &CSkinListCtrl2::OnNMRClick)//
END_MESSAGE_MAP()
...
void CSkinListCtrl2::DrawItem(LPDRAWITEMSTRUCT lpDrawItemStruct)
{
...
void CSkinListCtrl2::SetItemHeight(UINT nHeight)
{
...
void CSkinListCtrl2::SetHeaderStyle(void)
{
    CHeaderCtrl * pHeaderCtrl = GetHeaderCtrl();
...
void CSkinListCtrl2::OnNMRClick(NMHDR* /*pNMHDR*/, LRESULT* pResult)
{
    //LPNMITEMACTIVATE pNMItemActivate = reinterpret_cast<LPNMITEMACTIVATE>(pNMHDR);

    CMenu menu;	
    menu.CreatePopupMenu();
    menu.AppendMenu(MF_STRING | MF_ENABLED, 1000, _T("清空"));

    POINT pt;
    GetCursorPos(&pt);
    int nUserSel = menu.TrackPopupMenu(TPM_RIGHTALIGN | TPM_RIGHTBUTTON | TPM_RETURNCMD, pt.x, pt.y, this);
    menu.DestroyMenu();
    switch(nUserSel)
    {
    case 1000:
