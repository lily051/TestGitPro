...
<script type="text/javascript" src="/modules/device/collect/js/collect.js"></script>
<script type="text/javascript" src="/modules/device/collect/js/collectDevice.js"></script>
...
<div class="fullfit">
	<div class="toolbar">
		...
		<a href="#"><span class="managerOpr oprRemote"><i>远程配置</i></span></a>
		...
		<!-- <a href="#"><span class="managerOpr oprVideoIssue"><i>录像下发</i></span></a> -->
