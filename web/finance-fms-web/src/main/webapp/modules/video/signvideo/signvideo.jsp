...
<div class="fullfit">
	    ...
	    <form class="form-horizontal" id="filterForm">
	        ...
	        <div class="hideCondition" id="hideCondition">
	    	    ...
	    	    <fieldset class="noLegend fieldset_25">
					...
					<div class="control-group">
						<label class="control-label">是否合规：</label>
						<div class="controls conditions">
							<select name="" id="recordCheck">
								<option value="">全部</option>
	    	    ...
	    	    <fieldset class="noLegend fieldset_25">
					...
					<div class="control-group">
	    	    		<label class="control-label">纠纷情况：</label>
	    	    		<div class="controls conditions">
	    	    			<select name="" id="status">
	    	    				<option value="">全部</option>
	    	    				<option value="1">存在纠纷</option>
	    	    				<option value="0">无纠纷</option>
	    	    			</select>
	    	    		</div>
	    	    	</div>
	    	    </fieldset>
	...
	<div class="toolbar" style="padding:5px 0">
		<a href="#"><span class="managerOpr oprRandom"><i>随机检查</i></span></a>
		<a href="#"><span class="managerOpr oprCompliance"><i>合规检查</i></span></a>
