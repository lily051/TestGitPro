		...
		<fieldset class="noLegend halfField">
			...
			<div class="control-group <s:if test="saleInfo.compReason==null">hidden</s:if>">
				...
				<div class="controls" style="height:auto">
					<textarea name="saleInfo.compReason" readonly="readonly" style="resize:none;height:100px;width:475px;border:0;box-shadow:none;color:black">${saleInfo.compReason}</textarea>
				</div>
			</div>
			<div class="control-group">
				<label class="control-label">备注：</label>
				<div class="controls" style="height:auto">
					<textarea name="businessorder.strRemarks" readonly="readonly" style="resize:none;height:100px;width:475px;border:0;box-shadow:none;color:black">${saleInfo.strRemarks}</textarea>
				</div>
			</div>
		</fieldset>
		<fieldset class="noLegend halfField">
