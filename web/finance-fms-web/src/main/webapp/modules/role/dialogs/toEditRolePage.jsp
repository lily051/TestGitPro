...
<form class="form-horizontal form-fixed">
        ...
        <fieldset class="noLegend">
        	<input id="roleId" value="<s:property value="roleInfo.id"/>" type="hidden">
            <div class="control-group">
                <label class="control-label"><em>*</em>角色名称：</label>
                <div class="controls">
					<input id="roleName" type="text" vtype="common" required="true"
						class="auto-input" maxLength="50" data-icon="true"
						isoverflown="true" value="<s:property value="roleInfo.strName"/>">
				</div>
            </div>
            <!-- <div class="control-group">
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <input id="strRemarks" type="text"  value="<s:property value="roleInfo.strComment"/>" vtype="common" required="true" class="auto-input" maxLength="50" data-icon="true" isoverflown="true">
                </div>
            </div>
            <div class="control-group">
