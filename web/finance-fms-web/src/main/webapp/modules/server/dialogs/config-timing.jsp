...
<form class="form-horizontal form-fixed formLabel120">
        ...
        <fieldset class="noLegend">
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <input type="text" vtype="common" maxLength="50" required="true" class='auto-input' data-icon="true" isoverflown="true" name="serverInfo.strUser" value=""> 
                </div>
            </div>
            <div class="control-group">
                <label class="control-label"><em>*</em>服务IP：</label>
                <div class="controls">
                    <input type="text" vtype="ip" maxLength="15" required="true" class='auto-input' data-icon="true" isoverflown="true" name="serverInfo.strIp" value=""> 
                </div>
            </div>
            <div class="control-group">
                <label class="control-label"><em>*</em>控制端口：</label>
                <div class="controls">
                    <input name="serverInfo.nctrlPort" value="6680" type="text" class="auto-input"
...
<!--             <div class="control-group">
            ...
            <div class="control-group" >
                ...
                <div class="controls">
                    <input type="text" class="auto-input" minValue="0" maxValue="500" maxLength="3" required="true" vtype="num" isOverflown="true" data-icon="true" name="serverInfo.condition" value="15" self-focus-info="请输入0至500的有效数字" />
                </div>
            </div>
            <div class="control-group" id="FT">
                <label class="control-label"><em>*</em>校时时间点：</label>
                <div class="controls">
                    <input type="text" class="hikui-calendar auto-input" required="true" id="startTime"  hikui="calendar"  data-icon="true" name="serverInfo.time" datefmt="HH:mm:ss">
                </div>
            </div>
            <div class="control-group" id="intervalTime">
                <label class="control-label"><em>*</em>时间间隔(小时)：</label>
                <div class="controls">
                    <input type="text" class="auto-input" required="true" vtype="num" minValue="1" maxValue="24" maxLength="2" isOverflown="true" data-icon="true" name="serverInfo.fixedTime" value="8" self-focus-info="请输入1至24的有效数字"/>
                </div>
            </div>
            <!-- <div class="control-group">
