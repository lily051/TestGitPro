...
<!--             <div class="control-group">
            ...
            <div class="control-group ">
                ...
                <div class="controls">
                    <input name="serverInfo.timeOut" type="text" class="auto-input" required="true" vtype="num"
                                    minValue="2" maxValue="1000" maxLength="4" self-focus-info="请输入2至1000的有效数字" isOverflown="true" data-icon="true" value="2"/>
                </div>
            </div>
            <div class="control-group">
                <label class="control-label"><em>*</em>巡检服务IP：</label>
                <div class="controls">
                    <input type="text" vtype="ip" maxLength="50" required="true" class='auto-input' data-icon="true" isoverflown="true" name="serverInfo.strSysIp" value=""> 
                </div>
            </div>
            <div class="control-group">
