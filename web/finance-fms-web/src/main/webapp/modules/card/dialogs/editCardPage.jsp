	...
	<form class="form-horizontal form-fixed formLabel120">
		...
		<fieldset class="noLegend">
			<div class="control-group">
				...
				<div class="controls">
				<input type="hidden" name="paramdictionaryInfo.id" value="${paramdictionaryInfo.id}">
					<input type="text" vtype="common" data-icon="true" required="true" class="auto-input" maxLength="30" isoverflown="true" 
							id="collectName" name="paramdictionaryInfo.strName" value="${paramdictionaryInfo.strName}">
				</div>
			</div>
			<div class="control-group">
				...
				<div class="controls">
					<input type="text" vtype="num" data-icon="true" required="true" class="auto-input" maxLength="30" isoverflown="true" 
						id="collectIP" style="ime-mode: disabled;" name="paramdictionaryInfo.strCode" value="${paramdictionaryInfo.strCode}">
				</div>
			</div>
		</fieldset>
	</form>
