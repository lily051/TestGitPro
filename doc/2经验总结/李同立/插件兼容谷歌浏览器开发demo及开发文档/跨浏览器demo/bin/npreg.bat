...
reg add "HKEY_LOCAL_MACHINE\SOFTWARE\Wow6432Node\MozillaPlugins\@hikvision.com/hik-demo-plugin" /v "Path" /t REG_SZ /d "%~dp0nptest.dll" /f
...
reg add "HKEY_LOCAL_MACHINE\SOFTWARE\MozillaPlugins\@hikvision.com/hik-demo-plugin" /v "Path" /t REG_SZ /d "%~dp0nptest.dll" /f
