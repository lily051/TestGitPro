...
/** @ fn    HCS_SDK_SetBindIp
 *  @ brief  设置绑定IP信息
 *  @ param  ip				- [in] 绑定ip信息
 *  @ return HCS_OK-成功 其他-错误码
 */
HCS_SDK_EXTERN int HCS_SDK_API HCS_SDK_SetBindIp(const char* ip);
...
/** @ fn     HCS_SDK_GetCloudAbility
 *  @ brief  获取云存储能力集
 *  @ param  login_id		- [in] 云存储登录ID
 *  @ param  ability_buff	- [out] 云存储能力集信息（xml格式字符串）
 *  @ param  buff_len		- [in] 接收云存储能力集字符串缓存的长度，建议4096字节
 *  @ return HCS_OK-成功 其他-错误码
 */
HCS_SDK_EXTERN int HCS_SDK_API HCS_SDK_GetCloudAbility(unsigned long long login_id, 
													   char *ability_buff,
...
/** @ fn     HCS_SDK_GetAllRecPlanNext_V20
 *  @ brief  获取下一条录像计划信息
 *  @ param  login_id	- [in] 云存储登录ID
 *  @ param  handle		- [in] 获取全部录像计划信息操作句柄
 *  @ param  info		- [out] 获取的录像计划信息
 ...
 *  @ return HCS_OK-成功 其他-错误码
 */
HCS_SDK_EXTERN int HCS_SDK_API HCS_SDK_GetAllRecPlanNext_V20(unsigned long long login_id, 
															 int handle, 
															 HCS_RecordPlan_V20* info, 
															 int* alloc, 
															 int* status);
...
/** @ fn     HCS_SDK_SetRecPlan_V20
 *  @ brief  设置录像计划
 *  @ param  login_id	- [in] 云存储登录ID
 *  @ param  plan		- [in] 录像计划
 *  @ return HCS_OK-成功 其他-错误码
 */
HCS_SDK_EXTERN int HCS_SDK_API HCS_SDK_SetRecPlan_V20(unsigned long long login_id, 
													  const HCS_RecordPlan_V20* plan);



/** @ fn     HCS_SDK_GetRecPlan_V20
 *  @ brief  获取编码器对应的录像计划
 *  @ param  login_id	- [in] 云存储登录ID
 *  @ param  camera_id	- [in] 编码器ID
 *  @ param  plan		- [out]录像计划
 ...
 *  @ return HCS_OK-成功 其他-错误码
 */
HCS_SDK_EXTERN int HCS_SDK_API HCS_SDK_GetRecPlan_V20(unsigned long long login_id, 
													  const char* camera_id, 
													  HCS_RecordPlan_V20* plan, 
													  int* status);



/** @ fn     HCS_SDK_GetRecPlanAbility
 *  @ brief  获取录像计划能力集
 *  @ param  login_id	- [in] 云存储登录ID
 *  @ param  ability	- [out]录像计划接入能力集，包括实时流录像计划和历史流录像计划
 *  @ return HCS_OK-成功 其他-错误码
 */
HCS_SDK_EXTERN int HCS_SDK_API HCS_SDK_GetRecPlanAbility(unsigned long long login_id, 
														 HCS_RecPlanAbility* ability);
...
/** @ fn     HCS_SDK_RealtimeRecordStart
 *  @ brief  开始手动录像[最大支持1天的手动录像]
 *  @ param  login_id	- [in] 云存储登录ID
 *  @ param  rec_info	- [in] 手动录像参数
 *  @ param  task_id	- [out] 手动录像任务ID
 *  @ return HCS_OK-成功 其他-错误码
 */
HCS_SDK_EXTERN int HCS_SDK_API HCS_SDK_RealtimeRecordStart(unsigned long long login_id, 
														   const HCS_RealRecInfo* rec_info,
														   unsigned long long* task_id);




/** @ fn     HCS_SDK_RealtimeRecordStatus
 *  @ brief  获取手动录像状态
 *  @ param  login_id	- [in] 云存储登录ID
 *  @ param  task_id	- [in] 手动录像任务ID
 *  @ param  task_info	- [out]任务信息
 *  @ return HCS_OK-成功 其他-错误码
 */
HCS_SDK_EXTERN int HCS_SDK_API HCS_SDK_RealtimeRecordStatus(unsigned long long login_id, 
															unsigned long long task_id, 
															HCS_TaskInfo* task_info);



/** @ fn     HCS_SDK_RealtimeRecordStop
 *  @ brief  停止手动录像
 *  @ param  login_id	- [in] 云存储登录ID
 *  @ param  task_id	- [in] 手动录像任务ID
 *  @ param  url_len	- [in] url缓存区长度
 *  @ param  url		- [out] 返回的取流URL[可以通过URL取流也可以通过编码器，开始，结束时间取流]
 *  @ return HCS_OK-成功 其他-错误码
 */
HCS_SDK_EXTERN int HCS_SDK_API HCS_SDK_RealtimeRecordStop(unsigned long long login_id, 
														  unsigned long long task_id,
...
/** @ fn     HCS_SDK_GetRecHead_V20
 *  @ brief  获取录像头(支持录像和视频文件)
 *  @ param  login_id		- [in] 云存储登录ID
 *  @ param  data_info		- [in] 数据信息
 *  @ param  buff			- [in] 录像头数据缓冲区
 *  @ param  buff_size		- [in] 录像头数据缓冲区大小
 *  @ param  head_size		- [out]实际的录像头数据大小
 *  @ return HCS_OK-成功 其他-错误码
 */
HCS_SDK_EXTERN int HCS_SDK_API HCS_SDK_GetRecHead_V20(unsigned long long login_id, 
													  const HCS_GetHeadInfo* data_info, 
													  char* buff, 
													  unsigned int buff_size, 
													  int* head_size);
...
/** @ fn     HCS_SDK_PlaybackStart_V20
 *  @ brief  开启回放（支持录像和视频文件）
 *  @ param  login_id		- [in] 云存储登录ID
 *  @ param  data_info		- [in] 数据信息
 *  @ param  handle			- [out]录像回放操作句柄
 *  @ return HCS_OK-成功 其他-错误码
 */
HCS_SDK_EXTERN int HCS_SDK_API HCS_SDK_PlaybackStart_V20(unsigned long long login_id, 
														 const HCS_DataReadInfo* data_info,
														 int* handle);
 ...
 *  @ return HCS_OK-成功 其他-错误码
 */
HCS_SDK_EXTERN int HCS_SDK_API HCS_SDK_PlaybackChangeMode(unsigned long long login_id, 
														  int handle,
														  HCS_PlaybackMode mode);
...
/** @ fn     HCS_SDK_RecDownloadStart_V20
 *  @ brief  开启下载（支持录像和视频文件）
 *  @ param  login_id		- [in] 云存储登录ID
 *  @ param  data_info		- [in] 数据信息
 *  @ param  offset			- [in] 下载数据偏移(用于断点续传)
 *  @ param  cb				- [in] 录像下载数据回调函数
 ...
 *  @ return HCS_OK-成功 其他-错误码
 */
HCS_SDK_EXTERN int HCS_SDK_API HCS_SDK_RecDownloadStart_V20(unsigned long long login_id, 
															const HCS_DataReadInfo* data_info,
															unsigned long long offset, 
															RecDownloadCb cb, 
															void* user_data, 
...
/** @ fn     HCS_SDK_RecFrameExtractStart
 *  @ brief  抽帧显示 [从云存储中获取一段时间内的图片信息]
 *  @ param	 login_id			- [in] 成功登录云存储返回的句柄
 *  @ param  frame_info			- [in] 抽帧显示信息
 *  @ param  rec_frame_ext_cb	- [in] 每隔time_sikp时间下载图片数据的回调函数
 *  @ param  user_data			- [in] 用户自定义数据
 *  @ param  handle				- [out]抽帧显示下载操作句柄
 *  @ return HCS_OK-成功 其他-错误码
 */
HCS_SDK_EXTERN int HCS_SDK_API HCS_SDK_RecFrameExtractStart(unsigned long long login_id, 
															const HCS_RecFrameExtractInfo *frame_info, 
															RecFrameExtractCb rec_frame_ext_cb, 
															void* user_data, 
															int* handle);


/** @ fn     HCS_SDK_RecFrameExtractStop
 *  @ brief  停止抽帧显示
 *  @ param  login_id         - [in] 云存储登录ID
 *  @ param  handle           - [in] 成功开启抽帧显示返回的句柄
 *  @ return HCS_OK-成功 其他-错误码
 */
HCS_SDK_EXTERN int HCS_SDK_API HCS_SDK_RecFrameExtractStop(unsigned long long login_id, 
														   int handle);
 ...
 *                                                                           *
 *****************************************************************************/
/** @ fn     HCS_SDK_VideoWriteFromFileStart
 *  @ brief  开启视频文件存储
 *  @ param  login_id		- [in] 云存储登录ID
 *  @ param  file_info		- [in] 视频文件信息
 *  @ param  file_speed_cb	- [in] 异步上传文件进度回调函数
 *  @ param  user_data		- [in] 用户自定义数据
 *  @ param  url		    - [out]视频文件对应URL字符数组
 *  @ param  url_len	    - [in/out] 视频文件URL buff长度,开启成功，该字段返回实际的URL长度[建议1024]
 *  @ param  handle			- [out]视频文件操作句柄
 *  @ return HCS_OK-成功 其他-错误码
 */
HCS_SDK_EXTERN int HCS_SDK_API HCS_SDK_VideoWriteFromFileStart(unsigned long long login_id, 
															   const HCS_VideoFileWriteInfo* file_info, 
															   UploadFileSpeedCb file_speed_cb, 
															   void* user_data, 
															   char* url,  
															   unsigned int* url_len, 
															   int* handle);

/** @ fn     HCS_SDK_VideoWriteFromFileStop
 *  @ brief  停止视频文件存储
 *  @ param  login_id		- [in] 云存储登录ID
 *  @ param  handle			- [in] 视频文件操作句柄
 *  @ return HCS_OK-成功 其他-错误码
 */
HCS_SDK_EXTERN int HCS_SDK_API HCS_SDK_VideoWriteFromFileStop(unsigned long long login_id, 
															  int handle);

/** @ fn     HCS_SDK_SyncVideoWriteFromFile
 *  @ brief  同步视频文件存储
 *  @ param  login_id		- [in] 云存储登录ID
 *  @ param  file_info		- [in] 视频文件信息
 *  @ param  url		    - [out]视频文件对应URL字符数组
 ...
 *  @ return HCS_OK-成功 其他-错误码
 */
HCS_SDK_EXTERN int HCS_SDK_API HCS_SDK_SyncVideoWriteFromFile(unsigned long long login_id, 
															  const HCS_VideoFileWriteInfo* file_info,   
															  char* url,  
															  unsigned int* url_len);
...
/** @ fn     HCS_SDK_VideoFileReadStart
 *  @ brief  开启视频文件读取
 *  @ param  login_id		- [in] 云存储登录ID
 *  @ param  read_info		- [in] 视频文件读取信息
 *  @ param  handle			- [out]视频文件读取操作句柄
 *  @ return HCS_OK-成功 其他-错误码
 */
HCS_SDK_EXTERN int HCS_SDK_API HCS_SDK_VideoFileReadStart(unsigned long long login_id, 
														  const HCS_VideoReadInfo* read_info,
														  int* handle);



/** @ fn     HCS_SDK_VideoFileReadData
 *  @ brief  读取视频文件数据
 *  @ param  login_id		- [in] 云存储登录ID
 ...
 *  @ return HCS_OK-成功 其他-错误码
 */
HCS_SDK_EXTERN int HCS_SDK_API HCS_SDK_VideoFileReadData(unsigned long long login_id, 
														 int handle, 
														 char* buff, 
														 unsigned int buff_size, 
														 int* data_size);
 ...
 *  @ return HCS_OK-成功 其他-错误码
 */
HCS_SDK_EXTERN int HCS_SDK_API HCS_SDK_VideoFileReadSeek(unsigned long long login_id, 
														 int handle, 
														 HCS_Time seek_time);



/** @ fn     HCS_SDK_VideoFileReadStop
 *  @ brief  停止视频文件读取
 *  @ param  login_id		- [in] 云存储登录ID
 *  @ param  handle			- [in] 视频文件读取操作句柄
 *  @ return HCS_OK-成功 其他-错误码
 */
HCS_SDK_EXTERN int HCS_SDK_API HCS_SDK_VideoFileReadStop(unsigned long long login_id, 
														 int handle);



/** @ fn     HCS_SDK_VideoFileDownloadStart
 *  @ brief  开启视频文件下载
 *  @ param  login_id		- [in] 云存储登录ID
 *  @ param  read_info		- [in] 视频文件读取信息
 ...
 *  @ return HCS_OK-成功 其他-错误码
 */
HCS_SDK_EXTERN int HCS_SDK_API HCS_SDK_VideoFileDownloadStart(unsigned long long login_id, 
															  const HCS_VideoReadInfo* read_info, 
															  unsigned long long offset, 
															  RecDownloadCb cb, 
															  void* user_data, 
...
/** @ fn     HCS_SDK_VideoFileDownloadStop
 *  @ brief  停止视频文件下载
 *  @ param  login_id		- [in] 云存储登录ID
 *  @ param  handle			- [in] 视频文件下载操作句柄
 *  @ return HCS_OK-成功 其他-错误码
 */
HCS_SDK_EXTERN int HCS_SDK_API HCS_SDK_VideoFileDownloadStop(unsigned long long login_id, 
															 int handle);



/** @ fn     HCS_SDK_VideoFileInfo
 *  @ brief  获取视频文件信息
 *  @ param  login_id		- [in] 云存储登录ID
 *  @ param  info			- [in] 视频文件查询信息
 *  @ param  file_info		- [out] 视频文件信息
 *  @ return HCS_OK-成功 其他-错误码
 */
HCS_SDK_EXTERN int HCS_SDK_API HCS_SDK_VideoFileInfo(unsigned long long login_id, 
													 const HCS_VideoBaseInfo* info,
													 HCS_VideoFileInfo* file_info);



/** @ fn     HCS_SDK_VideoFileIndexStart
 *  @ brief  开启视频文件索引检索
 *  @ param  login_id		- [in] 云存储登录ID
 *  @ param  info			- [in] 视频文件信息
 *  @ param  handle			- [out]操作句柄
 *  @ return HCS_OK-成功 其他-错误码
 */
HCS_SDK_EXTERN int HCS_SDK_API HCS_SDK_VideoFileIndexStart(unsigned long long login_id, 
														   const HCS_VideoReadInfo* info,
														   int* handle);



/** @ fn     HCS_SDK_VideoFileIndexNext
 *  @ brief  查找下一条索引
 *  @ param  login_id		- [in] 云存储登录ID
 *  @ param  handle			- [in] 视频文件读取操作句柄
 *  @ param  index_Data		- [out]索引信息
 *  @ param  status			- [out] 获取视频文件索引结果[1-获取信息成功 2-正在查询请等待 3-没有更多的信息，查询结束]
 *  @ return HCS_OK-成功 其他-错误码
 */
HCS_SDK_EXTERN int HCS_SDK_API HCS_SDK_VideoFileIndexNext(unsigned long long login_id, 
														  int handle, 
														  HCS_FileIndexData* index_Data,
														  int* status );



/** @ fn     HCS_SDK_VideoFileIndexStop
 *  @ brief  停止索引检索
 *  @ param  login_id		- [in] 云存储登录ID
 *  @ param  handle			- [in] 视频文件读取操作句柄
 *  @ return HCS_OK-成功 其他-错误码
 */
HCS_SDK_EXTERN int HCS_SDK_API HCS_SDK_VideoFileIndexStop(unsigned long long login_id, 
														  int handle);



/** @ fn     HCS_SDK_VideoFileDelete
 *  @ brief  删除视频文件
 *  @ param  login_id		- [in] 云存储登录ID
 *  @ param  info			- [in] 视频文件信息
 *  @ return HCS_OK-成功 其他-错误码
 */
HCS_SDK_EXTERN int HCS_SDK_API HCS_SDK_VideoFileDelete(unsigned long long login_id, 
													   const HCS_VideoBaseInfo* info);
...
/** @ fn	 HCS_SDK_SmartSearchStart_V20
 *  @ brief	 开启智能检索(支持提前延后时间)
 *  @ param	 login_id				-[in] 云存储登录ID
 *  @ param	 param					-[in] 智能检索参数
 *  @ param	 handle					-[out] 智能检索句柄
 *  @ return HCS_OK-成功 其他-错误码
 */
HCS_SDK_EXTERN int HCS_SDK_API HCS_SDK_SmartSearchStart_V20(unsigned long long login_id, 
															const HCS_SmartSearchParam_V20* param, 
															int* handle);
 ...
 *                                                                            *
 ******************************************************************************/
/** @ fn	 HCS_SDK_SmartEventSearchStart
 *  @ brief	 开启智能事件检索
 *  @ param	 login_id				-[in] 云存储登录ID
 *  @ param	 param					-[in] 智能事件检索参数
 *  @ param	 handle					-[out] 智能事件检索句柄
 *  @ return HCS_OK-成功 其他-错误码
 */
HCS_SDK_EXTERN int HCS_SDK_API HCS_SDK_SmartEventSearchStart(unsigned long long login_id, 
															 const HCS_SmartEventSearchParam* param, 
															 int* handle);



/** @ fn	 HCS_SDK_SmartEventSearchNextInfo
 *  @ brief	 智能事件检索，检索下一条信息
 *  @ param	 login_id				-[in] 云存储登录ID
 *  @ param	 handle					-[in] 搜索句柄
 *  @ param	 result					-[out]保存搜索结果信息
 *  @ param	 status					-[out]检索结果[1-获取信息成功 2-正在查询请等待 3-没有更多的信息，查询结束]
 *  @ return HCS_OK-成功 其他-错误码
 */
HCS_SDK_EXTERN int HCS_SDK_API HCS_SDK_SmartEventSearchNextInfo(unsigned long long login_id, 
																int handle, 
																HCS_SmartEventSearchResult* result, 
																int* status);



/** @ fn     HCS_SDK_SmartEventSearchStop
 *  @ brief	 停止智能事件检索
 *  @ param	 login_id				-[in] 云存储登录ID
 *  @ param	 handle					-[in] 搜索句柄
 *  @ return HCS_OK-成功 其他-错误码
 */
HCS_SDK_EXTERN int HCS_SDK_API HCS_SDK_SmartEventSearchStop(unsigned long long login_id, 
															int handle);
