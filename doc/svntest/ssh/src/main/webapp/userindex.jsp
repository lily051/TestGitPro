...
//                                treeNode.addClass("selectedNode");
  ...
  <div id="nav" style="height: 30px">
    ...
    <%--<a class="orgSource" id="source"  href="${pageContext.request.contextPath}?currentModelCode=${orgcode}">组织资源</a>--%>
    <%--<a class="userManage" id="manager"  href="${pageContext.request.contextPath}?currentModelCode=${rolecode}">用户管理</a>--%>
