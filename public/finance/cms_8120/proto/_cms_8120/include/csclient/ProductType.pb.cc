...
void protobuf_AssignDesc_csclient_2fProductType_2eproto() {
  protobuf_AddDesc_csclient_2fProductType_2eproto();
  const ::google::protobuf::FileDescriptor* file =
    ::google::protobuf::DescriptorPool::generated_pool()->FindFileByName(
      "csclient/ProductType.proto");
  ...
  static const int ProductType_offsets_[6] = {
    ...
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(ProductType, pid_),
  ...
  static const int ReqProductType_offsets_[7] = {
    ...
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(ReqProductType, pid_),
  ...
  static const int ProductTypeList_offsets_[4] = {
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(ProductTypeList, cmd_),
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(ProductTypeList, result_),
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(ProductTypeList, result_info_),
...
inline void protobuf_AssignDescriptorsOnce() {
  ::google::protobuf::GoogleOnceInit(&protobuf_AssignDescriptors_once_,
                 &protobuf_AssignDesc_csclient_2fProductType_2eproto);
}
...
void protobuf_AddDesc_csclient_2fProductType_2eproto() {
  ...
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedFile(
    "csclient/ProductType.proto", &protobuf_RegisterTypes);
  ...
  ::google::protobuf::internal::OnShutdown(&protobuf_ShutdownFile_csclient_2fProductType_2eproto);
}

// Force AddDescriptors() to be called at static initialization time.
struct StaticDescriptorInitializer_csclient_2fProductType_2eproto {
  StaticDescriptorInitializer_csclient_2fProductType_2eproto() {
    protobuf_AddDesc_csclient_2fProductType_2eproto();
  }
} static_descriptor_initializer_csclient_2fProductType_2eproto_;
...
const int ProductType::kPidFieldNumber;
...
const ProductType& ProductType::default_instance() {
  if (default_instance_ == NULL) protobuf_AddDesc_csclient_2fProductType_2eproto();  return *default_instance_;
}
...
const int ReqProductType::kPidFieldNumber;
...
const int ProductTypeList::kResultFieldNumber;
const int ProductTypeList::kResultInfoFieldNumber;
  ...
  while ((tag = input->ReadTag()) != 0) {
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 3: {
        ...
        if (input->ExpectTag(34)) goto parse_productType;
        break;
      }
