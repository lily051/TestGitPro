...
#ifndef PROTOBUF_csclient_2fRegion_2eproto__INCLUDED
#define PROTOBUF_csclient_2fRegion_2eproto__INCLUDED
...
class ReqRegion : public ::google::protobuf::Message {
 ...
 private:
  ...
  friend void  protobuf_AddDesc_csclient_2fRegion_2eproto();
  friend void protobuf_AssignDesc_csclient_2fRegion_2eproto();
  friend void protobuf_ShutdownFile_csclient_2fRegion_2eproto();
...
// optional int32 result = 2;
inline bool RegionList::has_result() const {
  return (_has_bits_[0] & 0x00000002u) != 0;
}
inline void RegionList::set_has_result() {
  _has_bits_[0] |= 0x00000002u;
}
inline void RegionList::clear_has_result() {
  _has_bits_[0] &= ~0x00000002u;
}
inline void RegionList::clear_result() {
  result_ = 0;
  clear_has_result();
}
inline ::google::protobuf::int32 RegionList::result() const {
  return result_;
}
inline void RegionList::set_result(::google::protobuf::int32 value) {
  set_has_result();
  result_ = value;
}

// optional string result_info = 3;
inline bool RegionList::has_result_info() const {
  return (_has_bits_[0] & 0x00000004u) != 0;
}
inline void RegionList::set_has_result_info() {
  _has_bits_[0] |= 0x00000004u;
}
inline void RegionList::clear_has_result_info() {
  _has_bits_[0] &= ~0x00000004u;
}
inline void RegionList::clear_result_info() {
  if (result_info_ != &::google::protobuf::internal::kEmptyString) {
    result_info_->clear();
  }
  clear_has_result_info();
}
inline const ::std::string& RegionList::result_info() const {
  return *result_info_;
}
inline void RegionList::set_result_info(const ::std::string& value) {
  set_has_result_info();
  if (result_info_ == &::google::protobuf::internal::kEmptyString) {
...
inline void RegionList::set_result_info(const char* value) {
  set_has_result_info();
  if (result_info_ == &::google::protobuf::internal::kEmptyString) {
    result_info_ = new ::std::string;
  }
...
inline void RegionList::set_result_info(const char* value, size_t size) {
  set_has_result_info();
  if (result_info_ == &::google::protobuf::internal::kEmptyString) {
    result_info_ = new ::std::string;
  }
...
inline ::std::string* RegionList::mutable_result_info() {
  set_has_result_info();
  if (result_info_ == &::google::protobuf::internal::kEmptyString) {
    result_info_ = new ::std::string;
  }
...
inline ::std::string* RegionList::release_result_info() {
  clear_has_result_info();
  if (result_info_ == &::google::protobuf::internal::kEmptyString) {
    return NULL;
  } else {
...
#endif  // PROTOBUF_csclient_2fRegion_2eproto__INCLUDED
