...
// source: center/ProductType.Proto

#ifndef PROTOBUF_center_2fProductType_2eProto__INCLUDED
#define PROTOBUF_center_2fProductType_2eProto__INCLUDED
...
class ProductType : public ::google::protobuf::Message {
 ...
 private:
  ...
  friend void  protobuf_AddDesc_center_2fProductType_2eProto();
  friend void protobuf_AssignDesc_center_2fProductType_2eProto();
  friend void protobuf_ShutdownFile_center_2fProductType_2eProto();
...
// optional int32 nParentId = 2;
inline bool ProductType::has_nparentid() const {
  return (_has_bits_[0] & 0x00000002u) != 0;
}
inline void ProductType::set_has_nparentid() {
  _has_bits_[0] |= 0x00000002u;
}
inline void ProductType::clear_has_nparentid() {
  _has_bits_[0] &= ~0x00000002u;
}
inline void ProductType::clear_nparentid() {
  nparentid_ = 0;
  clear_has_nparentid();
}
inline ::google::protobuf::int32 ProductType::nparentid() const {
  return nparentid_;
}
inline void ProductType::set_nparentid(::google::protobuf::int32 value) {
  set_has_nparentid();
  nparentid_ = value;
}
...
// optional int32 nParentId = 3;
inline bool ReqProductType::has_nparentid() const {
  return (_has_bits_[0] & 0x00000004u) != 0;
}
inline void ReqProductType::set_has_nparentid() {
  _has_bits_[0] |= 0x00000004u;
}
inline void ReqProductType::clear_has_nparentid() {
  _has_bits_[0] &= ~0x00000004u;
}
inline void ReqProductType::clear_nparentid() {
  nparentid_ = 0;
  clear_has_nparentid();
}
inline ::google::protobuf::int32 ReqProductType::nparentid() const {
  return nparentid_;
}
inline void ReqProductType::set_nparentid(::google::protobuf::int32 value) {
  set_has_nparentid();
  nparentid_ = value;
}
...
#endif  // PROTOBUF_center_2fProductType_2eProto__INCLUDED
