...
void CPPHtmlDrawer::ReplaceSpecChars()
{
	...
	if (!m_bEnableEscapeSequences)
	{
		...
		//RUS: §µ§Õ§Ñ§Ý§ñ§Ö§Þ §ã§á§Ö§è§Ú§Ñ§Ý§î§ß§í?§ã§Ú§Þ§Ó§à§Ý?
	...
	else
	{
		...
		//RUS: §©§Ñ§Þ§Ö?§Ö§Þ §ã§á§Ö§è§Ú§Ñ§Ý§î§ß§í?§ã§Ú§Þ§Ó§à§Ý?HTML §ä§ï§Ô§Ñ§Þ§Ú
...
void CPPHtmlDrawer::DrawHtml (LPSIZE lpSize, LPCRECT lpRect)
{
	...
	//RUS: §°§Ô§â§Ñ§ß§Ú§é§Ú§Ó§Ñ§ð§ë§Ö§Û §á§â§ñ§Þ§à§å§Ô§à§Ý§î§ß§Ú§Ü §Õ§Ý§ñ §ä§Ö§Ü§å§ë§Ö?§à§Ò§Ý§Ñ§ã§ä?§Ó§í§Ó§à§Õ§Ñ
	RECT rcArea;
	...
	if (MODE_FIRSTPASS == m_nNumPass)
	{
		...
		//RUS: ?§â§Ö§Ø§Ú§Þ§Ö §á§à§Õ§Ô§à§ä§à§Ó§Ü§Ú §à§é§Ú§ë§Ñ§Ö?§Ó§ã§á§à§Þ§à§Ô§Ñ§ä§Ö§Ý§î§ß§í?§ä§Ñ§Ò§Ý§Ú§è?
		m_arrLinks.clear();
//		m_arrTable.clear();
		m_arrHtmlLine.clear();
//		m_arrTableSizes.clear();
	...
	//RUS: §©§Ñ§á§à§Þ§Ú§ß§Ñ§Ö§Þ §ä§Ö§Ü§å§ë§Ú?§ß§Ñ§ã§ä§â§à§Û§Ü?§Ü§à§ß§ä§Ö§Ü§ã§ä §å§ã§ä§â§à§Û§ã§ä§Ó§Ñ
...
//			strText = _T("<body>") + strText + _T("</body>");
		...
		//RUS: §¦§ã§Ý§Ú §ä§Ñ§Ò§Ý§Ú§è?§Ò§í§Ý§Ñ §ß§Ñ§Û§Õ§Ö§ß?
		if (bFoundTable)
		{
			//ENG: Searching an end of the table
			//RUS: §ª§ë§Ö§Þ §à§Ü§à§ß§é§Ñ§ß§Ú?§ä§Ñ§Ò§Ý§Ú§è?
			nBegin = nIndex;
			nIndex += 6;
			SearchEndOfTable(m_csHtmlText, nIndex);

			//ENG: Cuts a text of a table
			//RUS: §£§í§â§Ö§Ù§Ñ§Ö§Þ §ä§Ö§Ü§ã?§ä§Ñ§Ò§Ý§Ú§è?
			strText = m_csHtmlText.Mid(nBegin, nIndex - nBegin);

			//ENG: Output a table
			//RUS: §£§í§Ó§à?§ä§Ñ§Ò§Ý§Ú§è?
	...
	//RUS: §£§à§ã§ã§ä§Ñ§ß§Ñ§Ó§Ý§Ú§Ó§Ñ§Ö?§ß§Ñ§ã§ä§â§à§Ü§Ú §Ü§à§ß§ä§Ö§Ü§ã§ä?§å§ã§ä§â§à§Û§ã§ä§Ó§Ñ
...
SIZE CPPHtmlDrawer::DrawHtmlTable (CPPString & sTable, LPCRECT lpRect)
{
	...
	//RUS: §¯§Ñ§é§Ú§ß§Ñ§Ö§Þ §ß§à§Ó§å?§ä§Ñ§Ò§Ý§Ú§è?
	m_nCurTable++;
	...
	if (MODE_FIRSTPASS == m_nNumPass) 
	{
		...
		//RUS: §±§à§Ý§å§é§Ñ§Ö§Þ §â§Ñ§Ù§Þ§Ö§â?§ä§Ñ§Ò§Ý§Ú§è?
...
//		sc.nWidth = 0;
		...
		//RUS: §³§à§Ù§Õ§Ñ§Ö?§ê§Ñ§Ò§Ý§à§ß §á§å§ã§ä§à§Û §ä§Ñ§Ò§Ý§Ú§è?
		vecRow rows;
		...
		//ENG: Add a new table
		//RUS: §¥§à§Ò§Ñ§Ó§Ý§ñ§Ö§Þ §ß§à§Ó§å?§ä§Ñ§Ò§Ý§Ú§è?
		m_arrTables.push_back(st);
	} //if

	//ENG: Gets an info about a current table
	//RUS: §£§Ù§ñ§ä§î §Ú§ß§æ§à§â§Þ§Ñ§è§Ú§ð ?§ä§Ö§Ü§å§ë§Ö?§ä§Ñ§Ò§Ý§Ú§è?
	...
	//RUS: §±§â§Ú§Þ§Ö§ß§ñ§Ö§Þ §ã§ä§Ú§Ý?§ä§Ñ§Ò§Ý§Ú§è?(§ä§ï?<table>)
	...
	//RUS: §±§â§à§á§å§ã§Ü§Ñ§Ö§Þ §ä§ï?§ß§Ñ§é§Ñ§Ý§Ñ §ñ§é§Ö§Û§Ü??§á§à§Ý§å§é§Ñ§Ö§Þ §ã§ä§â§à§Ü§å §ã§Ó§à§Û§ã§ä?§ä§ï§Ô§Ñ
	int nIndex = 0;
	CPPString sTag;
	...
	//RUS: §¡§ß§Ñ§Ý§Ú§Ù§Ú§â§å§Ö?§ã§Ó§à§Û§ã§ä§Ó§Ñ §ä§ï§Ô§Ñ
	...
	if (MODE_FIRSTPASS != m_nNumPass)
	{
		...
		//RUS: §±§à§Ý§å§é§Ñ§Ö§Þ §â§Ö§Ñ§Ý§î§ß§í§Ö §â§Ñ§Ù§Þ§Ö§â?§ä§Ñ§Ò§Ý§Ú§è?
		...
		//RUS: §£§í§â§Ñ§Ó§ß§Ú§Ó§Ñ§ß§Ú§Ö §ä§Ñ§Ò§Ý§Ú§è?§á§à §Ô§à§â§Ú§Ù§à§ß§ä§Ñ§Ý?
		int nRealWidth = lpRect->right - lpRect->left;

		if (nWidthTable < nRealWidth)
		{
			//RUS: §±§à§á§í§ä§Ñ§Ö§Þ? §â§Ñ§ã§ä§ñ§ß§å§ä§î §ä§Ñ§Ò§Ý§Ú§è?§ß§Ñ §Ó§ã?§Õ§à§ã§ä§å§á§ß§å?§à§Ò§Ý§Ñ§ã§ä?
...
//			rcTable.bottom += m_defStyle.nBorderWidth * 2;
	...
	if (MODE_DRAW != m_nNumPass)
	{
		...
		//RUS: §¡§ß§Ñ§Ý§Ú§Ù §ê§Ú§â§Ú§ß§í §ñ§é§Ö§Û§Ü?
		...
		//RUS: §¡§ß§Ñ§Ý§Ú§Ù §Ó§í§ã§à§ä§í §ñ§é§Ö§Û§Ü?
...
//		size.cx = GetTableWidth(strTable, 0, size.cx, TRUE);
	...
	//RUS: §³§à§ç§â§Ñ§ß§ñ§Ö§Þ §ä§Ö§Ü§å§ë§å?§ä§Ñ§Ò§Ý§Ú§è?
	m_arrTables [nIndexTable] = cur_table;

	//ENG: Restore styles before <table> tag
	//RUS: §£§à§ã§ã§ä§Ñ§ß§Ñ§Ó§Ý§Ú§Ó§Ñ§Ö?§ã§ä§Ú§Ý?§Õ§à §ä§ï§Ô§Ñ <table>
	m_defStyle.strTag = _T("table");
...
void CPPHtmlDrawer::DrawHtmlTableRow(CPPString & sRow, LPCRECT lpRect, STRUCT_TABLE & st, int nRow)
{
	...
	//RUS: §±§â§Ú§Þ§Ö§ß§ñ§Ö§Þ §ã§ä§Ú§Ý?§ã§ä§â§à§Ü§Ú (§ä§ï?<tr>)
	...
	while (nIndex < sRow.GetLength())
	{
		...
		//RUS: §ª§ë§Ö§Þ §Ü§à§ß§Ö?§ñ§é§Ö§Û§Ü?§Ú§Ý?§ß§Ñ§é§Ñ§Ý§à §Ó§Ý§à§Ø§Ö§ß§ß§à?§ä§Ñ§Ò§Ý§Ú§è?
		SearchTag(sRow, nEndRow, _T("/tr"));
		SearchTag(sRow, nNewCell, _T("td"));
		if (nNewCell < nEndRow)
		{
			//ENG: Search an existing cell
			//RUS: §±§à§Ú§ã?§ã§å§ë§Ö§ã§ä§Ó§å§ð§ë§Ö§Û §ñ§é§Ö§Û§Ü?
			...
			//RUS: §ª§ë§Ö§Þ §à§Ü§à§ß§é§Ñ§ß§Ú?§ñ§é§Ö§Û§Ü?
			nIndex = nNewCell;
			...
			if (MODE_FIRSTPASS != m_nNumPass)
			{
				...
				//RUS: §±§à§Ý§å§é§Ñ§Ö§Þ §â§Ö§Ñ§Ý§î§ß§í§Û §á§â§ñ§Þ§à§å§Ô§à§Ý§î§ß§Ú§Ü §Õ§Ý§ñ §Ó§í§Ó§à§Õ§Ñ §ñ§é§Ö§Û§Ü?
				rcCell = *lpRect;
				...
				//RUS: cellspacing - §à§ä§ã§ä§å§á §à§ä §Ü§à§ß§ä§å§â?§ä§Ñ§Ò§Ý§Ú§è?§Õ§à §ñ§é§Ö§Û§Ü?
//				rcCell.left += m_defStyle.nPadding;
//				rcCell.top += m_defStyle.nPadding;
...
//				rcCell.bottom -= m_defStyle.nPadding;
			...
			if (MODE_DRAW != m_nNumPass)
			{
				...
				//RUS: §¥§à§Ò§Ñ§Ó§Ý§ñ§Ö§Þ §à§ä§ã§ä§å§á §ñ§é§Ö§Û§Ü?§à§ä
...
//				sc.szCell.cy += m_defStyle.nPadding + m_defStyle.nPadding;
				...
				//RUS: §©§Ñ§á§à§Þ§Ú§ß§Ñ§Ö§Þ §à§Ò§ì§Ö§Õ§Ú§ß§Ö§ß§ß§í§Ö §ñ§é§Ö§Û§Ü?
	...
	//RUS: §£§à§ã§ã§ä§Ñ§ß§Ñ§Ó§Ý§Ú§Ó§Ñ§Ö?§ã§ä§Ú§Ý?§Õ§à §ä§ï§Ô§Ñ <tr>
	m_defStyle.strTag = _T("tr");
	if (StoreRestoreStyle(TRUE))
		UpdateContext();
...
void CPPHtmlDrawer::DrawHtmlTableCell(CPPString & sCell, LPCRECT lpRect, STRUCT_CELL & sc)
{
	...
	//RUS: §±§â§Ú§Þ§Ö§ß§ñ§Ö§Þ §ã§ä§Ú§Ý?§ñ§é§Ö§Û§Ü?(§ä§ï?<td>)
	...
	if (MODE_FIRSTPASS == m_nNumPass)
	{
		...
		//RUS: §³§à§ç§â§Ñ§ß§ñ§Ö§Þ §Ú§ß§æ§à§â§Þ§Ñ§è§Ú§ð §à§Ò §à§Ò§ì§Ö§Õ§Ú§ß§Ö§ß§Ú?§ñ§é§Ö§Ö§Ü
		sc.nColSpan = szSpan.cx;
		sc.nRowSpan = szSpan.cy;
		//ENG: Stores an info about the recommended cell sizes
		//RUS: §³§à§ç§â§Ñ§ß§ñ§Ö§Þ §Ú§ß§æ§à§â§Þ§Ñ§è§Ú§ð §à§Ò §â§Ö§Ü§à§Þ§Ö§ß§Õ§à§Ó§Ñ§ß§ß§í?§â§Ñ§Ù§Þ§Ö§â§Ñ§ç §ñ§é§Ö§Û§Ü?
...
//		sc.bHeightPercent = m_defStyle.bCellHeightPercent;
		//ENG: 
		//RUS: §¦§ã§Ý§Ú §å§Ü§Ñ§Ù§Ñ§ß?§Þ§Ú§ß§Ú§Þ§Ñ§Ý§î§ß§í?§âa§Ù§Þ§Ö§â?§ñ§é§Ö§Û§Ü? §ä§à §å§ã§ä§Ñ§ß§à§Ó§Ú§ä§î §Ú§ç §Ü§Ñ?§ß§Ñ§é§Ñ§Ý§î§ß§í?
...
//		sc.szText.cy = m_defStyle.nCellHeight;
	...
	else if (MODE_DRAW == m_nNumPass)
	{
		...
		if (m_defStyle.nFillBkgnd >= 0)
		{
			...
			//RUS: §©§Ñ§á§à§Ý§ß§Ö§ß§Ú§Ö §æ§à§ß§Ñ §ñ§é§Ö§Û§Ü?
		...
		//RUS: cellpadding - §à§ä§ã§ä§å§á §à§ä §Ü§à§ß§ä§å§â?§ñ§é§Ö§Û§Ü? §Õ§à §ä§Ö§Ü§ã§ä§Ñ §Ó§ß§å§ä§â§Ú §Ö§Ö
	...
	while(nIndex < sCell.GetLength())
	{
		...
		//RUS: §±§à§Ý§å§é§Ñ§Ö§Þ §Ú§ß§Õ§Ö§Ü§ã §Ò§Ý§Ú§Ø§Ñ§Û§ê§Ö§Ô§à §ä§ï§Ô§Ñ
		...
		if (nNearlyTag > nIndex)
		{
			...
			//RUS: §¦§ã§Ý§Ú §Þ§Ö§Ø§Õ?§á§à§ã§Ý§Ö§Õ§ß§Ú?§Ú§ß§Õ§Ö§Ü§ã§à§Þ ?§ä§Ö§Ü§å§ë§Ú?§Ú§ß§Õ§Ö§Ü§ã§à§Þ §ã§å§ë§Ö§ã§ä§Ó§å§Ö§ä §ä§Ö§Ü§ã?
		...
		else if (nNewTable < nEndCell)
		{
			...
			//RUS: §¯§Ñ§Û§Õ§Ö§ß?§Ó§Ý§à§Ø§Ö§ß§ß§Ñ§ñ §ä§Ñ§Ò§Ý§Ú§è?
			nIndex = nNewTable;
		...
		if (MODE_DRAW != m_nNumPass)
		{
			...
			//RUS: §¯§Ñ §á§Ö§â§Ó§à§Þ ?§Ó§ä§à§â§à§Þ §á§â§à§ç§à§Õ§Ñ§ç §Ó§í§é§Ú§ã§Ý§ñ§Ö§Þ §â§Ñ§Ù§Þ§Ö§â?§ñ§é§Ö§Û§Ü?
	...
	if (MODE_DRAW != m_nNumPass)
	{
		...
		//RUS: §¥§à§Ò§Ñ§Ó§Ý§ñ§Ö§Þ §à§ä§ã§ä§å§á?§ä§Ö§Ü§ã§ä§Ñ §à§ä §Ô§â§Ñ§ß§Ú§è §ñ§é§Ö§Û§Ü?
	...
	//RUS: §£§à§à§ã§ä§Ñ§ß§Ñ§Ó§Ý§Ú§Ó§Ñ§Ö?§ã§ä§Ú§Ý? §Ü§à§ä§à§â§í?§Ò§í§Ý§Ú §Õ§à §ä§ï§Ô§Ñ <td>
	m_defStyle.strTag = _T("td");
	if (StoreRestoreStyle(TRUE))
		UpdateContext();
}
...
SIZE CPPHtmlDrawer::DrawHtmlString (CPPString & sHtml, LPCRECT lpRect)
{
	...
	//RUS: §¥§Ý§ñ §Ý§ð§Ò§à?§ã§ä§â§à§Ü§Ú §Õ§à§Ò§Ñ§Ó§Ý§ñ§Ö§Þ §ä§ï?<body>
	sHtml = _T("<body>") + sHtml;
	sHtml += _T("</body>");

	//ENG: Bounding rectangle for a full text
	//RUS: §°§Ô§â§Ñ§ß§Ú§é§Ú§Ó§Ñ§ð§ë§Ú§Û §á§â§ñ§Þ§à§å§Ô§à§Ý§î§ß§Ú§Ü §Õ§Ý§ñ §Ó§í§Ó§à§Õ§Ñ §Ó§ã§Ö§Ô?§ä§Ö§Ü§ã§ä§Ñ
	...
	//RUS: §º§Ú§â§Ú§ß§Ñ §à§Ô§â§Ñ§ß§Ú§é§Ú§Ó§Ñ§ð§ë§Ö§Ô?§á§â§ñ§Þ§à§å§Ô§à§Ý§î§ß§Ú§Ü?
	int nTextWrapWidth = m_rcOutput.right - m_rcOutput.left;

	//ENG: A current position for output
	//RUS: §´§Ö§Ü§å§ë§Ñ§ñ §á§à§Ù§Ú§è§Ú§ñ §Õ§Ý§ñ §Ó§í§Ó§à§Õ§Ñ
	POINT ptOutput;
...
//	m_szOutput = CSize(0, 0);
	...
	//RUS: §¦§ã§Ý§Ú §ä§Ö§Ü§ã§ä§Ñ §Õ§Ý§ñ §Ó§í§Ó§à§Õ§Ñ §ß§Ö?
//	if (str.IsEmpty())
//	{
//		szTextArea.cx = szTextArea.cy = 0;
//		return;
...
//	pt.y = lpRect->top;
	...
	//RUS: §ª§ß§Ú§è§Ú§Ñ§Ý§Ú§Ù§Ñ§è§Ú§ñ §ß§à§Ó§à?§ã§ä§â§à§Ü§Ú
	...
	while (i < sHtml.GetLength())
	{
		...
		//RUS: §±§à§Ú§ã?§á§Ö§â§Ó§à§Ô?§ä§ï§Ô§Ñ
		sText = SearchNextTag(sHtml, sTag, i);
		sProperties = SplitTag(sTag);

		//ENG: Before a tag was exist a text
		//RUS: §±§Ö§â§Ö?§ä§ï§Ô§à?§Ö§ã§ä§î §ä§Ö§Ü§ã?§Õ§Ý§ñ §Ó§í§Ó§à§Õ§Ñ
		if (!sText.IsEmpty())
		{
			//ENG: Transform text
			//RUS: §±§â§Ö§à§Ò§â§Ñ§Ù§å§Ö?§ä§Ö§Ü§ã?
			switch (m_defStyle.nTextTransform)
			{
			case TEXT_TRANSFORM_UPPERCASE:
				//ENG: All chars make upper
				//RUS: §£§ã?§ã§Ú§Þ§Ó§à§Ý?§á§Ö§â§Ö§Ó§à§Õ§Ú??§Ó§Ö§â§ç§ß§Ú?§â§Ö§Ô§Ú§ã§ä?
				sText.MakeUpper();
				break;
			case TEXT_TRANSFORM_LOWERCASE:
				//ENG: All chars make lower
				//RUS: §£§ã?§ã§Ú§Þ§Ó§à§Ý?§á§Ö§â§Ö§Ó§à§Õ§Ú??§ß§Ú§Ø§ß§Ú§Û §â§Ö§Ô§Ú§ã§ä?
				sText.MakeLower();
				break;
			case TEXT_TRANSFORM_CAPITALIZE:
				//ENG: Each first char of a word to upper
				//RUS: §¬§Ñ§Õ§í?§á§Ö§â§Ó§í§Û §ã§Ú§Þ§Ó§à§Ý §ã§Ý§à§Ó??§Ó§Ö§â§ç§ß§Ú?§â§Ö§Ô§Ú§ã§ä? §à§ã§ä§Ñ§Ý§î§ß§í??§ß§Ú§Ø§ß§Ú§Û
				sText.MakeLower();
			...
			//RUS: §©§Ñ§è§Ú§Ü§Ý§Ú§Ó§Ñ§Ö?§Õ§à §ä§Ö?§á§à? §á§à§Ü§Ñ §ß§Ö §Ò§å§Õ§Ö?§Ó§í§Ó§Ö§Õ§Ö?§Ó§Ö§ã§î §ä§Ö§Ü§ã?
			while (!sText.IsEmpty())
			{
				//ENG: Reset an additional interval for space chars
				//RUS: §³§Ò§â§à?§Õ§à§á§à§Ý§ß§Ú§ä§Ö§Ý§î§ß§à§Ô?§Ú§ß§ä§Ö§â§Ó§Ñ§Ý?§Þ§Ö§Ø§Õ?§ã§Ý§à§Ó§Ñ§Þ?
				::SetTextJustification(m_hDC, 0, 0);

				//ENG: Gets a size a output text
				//RUS: §±§à§Ý§å§é§Ñ§Ö§Þ §â§Ñ§Ù§Þ§Ö§â §Ó§í§Ó§à§Õ§Ú§Þ§à§Ô§à §ä§Ö§Ü§ã§ä§Ñ
				::GetTextExtentPoint32(m_hDC, sText, sText.GetLength(), &sz);

				//ENG: Gets a real top coordinate to output with vertical alignment
				//RUS: §±§à§Ý§å§é§Ñ§Ö§Þ §â§Ö§Ñ§Ý§î§ß§å§ð §Ü§à§à§Õ§Ú§ß§Ñ§ä?§Ó§Ö§â§ç?§Ó§í§Ó§à§Õ§Ñ ?§å§é§Ö§ä§à§Þ §Ó§Ö§â§ä§Ú§Ü§Ñ§Ý§î§ß§à§Ô?§Ó§í§â§Ñ§Ó§ß§Ú§Ó§Ñ§ß?
				...
				if (MODE_DRAW == m_nNumPass)
				{
					if (sz.cx)
					{
						if ((0 == (nRealWidth - sz.cx)) && (_T(' ') == sTemp.GetAt(sTemp.GetLength() - 1)))
						{
							...
							//RUS: §¦§ã§Ý§Ú §ï§ä?§á§à§ã§Ý§Ö§Õ§ß§Ú?§Ó§í§Ó§à??§ã§ä§â§à§Ü§Ö, §ä§à §å§Ò§Ú§â§Ñ§Ö?§á§â§à§Ò§Ö§Ý?§ã§á§â§Ñ§Ó§Ñ
							sTemp.TrimRight();
						...
						//RUS: §³§à§ç§â§Ñ§ß§ñ§Ü§Þ §ä§Ö§Ü§å§ë§å?§à§Ò§Ý§Ñ§ã§ä?§Ü§Ñ?§à§Ò§Ý§Ñ§ã§ä?§Ô§Ú§á§Ö§â§Ý§Ú§ß§Ü§Ñ §Ö§ã§Ý§Ú §à§ß §å§ã§ä§Ñ§ß§à§Ó§Ý§Ö§ß
						StoreHyperlinkArea(ptOutput.x, y, ptOutput.x + sz.cx, y + sz.cy);
						
						//ENG: Real output a text
						//RUS: §£§í§Ó§à?§ä§Ö§Ü§ã§ä§Ñ
						::TextOut(m_hDC, ptOutput.x, y, sTemp, sTemp.GetLength());
						nSpacesInLine -= GetCountOfChars(sTemp);
						
						//ENG: If sets an overline style then draw a line over the text
						//RUS: §¦§ã§Ý§Ú §å§ã§ä§Ñ§ß§à§Ó§Ý§Ö§ß §ã§ä§Ú§Ý?overline, §ä§à §â§Ú§ã§å§Ö§Þ §Ý§Ú§ß§Ú?§ß§Ñ?§ä§Ö§Ü§ã§ä§à?
				...
				else
				{
					...
					//RUS: §³§à§ç§â§Ñ§ß§ñ§Ö§Þ §á§à§ã§Ý§Ö§Õ§ß§Ö?§Ô§à§â§Ú§Ù§à§ß§ä§Ñ§Ý§î§ß§à§Ö §Ó§í§â§Ñ§Ó§ß§Ú§Ó§Ñ§ß§Ú§Ö
				...
				//RUS: §±§Ö§â§Ö§Þ§Ö§ë§Ñ§Ö§Þ? §ã§á§â§Ñ§Ó§Ñ §à§ä §Ó§í§Ó§Ö§Õ§Ö§ß§ß§à§Ô?§ä§Ö§Ü§ã§ä§Ñ
				ptOutput.x += sz.cx;
				if (!sText.IsEmpty())
				{
					//ENG: Not all text was printed (cause text wrap) 
					//RUS: §¯§Ö §Ó§ã§ñ §ã§ä§â§à§Ü§Ñ §Ö§ë?§Ó§í§Ó§Ö§Ý§Ñ§ã§î (?§ã§Ý§å§é§Ñ§Ö §á§Ö§â§Ö§ß§à§ã§Ñ §ä§Ö§Ü§ã§ä§Ñ)
		...
		//RUS: §¦§ã§Ý§Ú §ä§ï?§ß§Ñ§Û§Õ§Ö§ß, §Ñ§ß§Ñ§Ý§Ú§Ù§Ú§â§å§Ö?...
		if (!sTag.IsEmpty())
		{
			//ENG: Reset temporary parameters
			//RUS: §³§Ò§â§à?§Ó§â§Ö§Þ§Ö§ß§ß§í?§á§Ñ§â§Ñ§Þ§Ö§ä§â§à§Ó
			m_defStyle.strTag.Empty();
			bCloseTag = FALSE;
			
			//ENG: Get Tag's name
			//RUS: §±§à§Ý§å§é§Ñ§Ö§Þ §Ú§Þ§ñ §ä§ï§Ô§Ñ
			nIndex = 0;
			
			//ENG: Searching a tag's value
			//RUS: §±§à§Ú§ã?§Ù§ß§Ñ§é§Ö§ß? §ä§ï§Ô§Ñ
			DWORD dwTag = GetTagFromList(sTag, m_defStyle.strTag, bCloseTag);
			
			//ENG: If a tag was found in a list of the tags
			//RUS: §¦§ã§Ý§Ú §ä§ï?§ß§Ñ§Û§Õ§Ö§ß ?§ã§á§Ú§ã§Ü§Ö
			if (TAG_NONE != dwTag)
			{
				//ENG: If it is a style tag 
				//RUS: §¦§ã§Ý§Ú §ä§Ö§Ü§å§ë§Ú?§ä§ï?§Õ§Ý§ñ §â§Ñ§Ò§à§ä§í §ã§à §ã§ä§Ú§Ý§ñ§Þ§Ú
				if (!m_defStyle.strTag.IsEmpty())
				{
					//ENG: Checks on permissibility of tag
					//RUS: §±§â§à§Ó§Ö§â§ñ§Ö§Þ §ß§Ñ §Õ§à§á§å§ã§ä§Ú§Þ§à§ã§ä§î §ä§ï§Ô§Ñ
					if (StoreRestoreStyle(bCloseTag))
					{
						//ENG: If it isn't a close tag
						//RUS: §¦§ã§Ý§Ú §ï§ä?§ß§Ö §à§Ü§à§ß§é§Ñ§ß§Ú?§ä§ï§Ô§Ñ
						if (!bCloseTag)
						{
							//ENG: Processing a tag
							//RUS: §°§Ò§â§Ñ§Ò§à§ä§Ü?§ä§ï§Ô§Ñ
							switch (dwTag)
							{
							case TAG_BOLD:
							...
							case TAG_HYPERLINK:
								...
								//RUS: §©§ß§Ñ§é§Ö§ß? §á§à §å§Þ§à§Ý§é§Ñ§ß§Ú?
								...
								//RUS: §±§à§Ý§å§é§Ñ§Ö§Þ §Ú§ß§Õ§Ö§Ü§ã §ä§Ö§Ü§å§ë§Ö?§Ô§Ú§á§Ö§â§ã§ã§í§Ý§Ü?
								m_nCurIndexLink ++;
								//ENG: If a mouse over this link
								//RUS: §¦§ã§Ý§Ú §Þ§í?§ß§Ñ?§ï§ä§Ú§Þ §ä§ï§Ô§à?
							...
							//RUS: §°§Ò§ß§à§Ó§Ý§Ö§ß§Ú§Ö §Ü§à§ß§ä§Ö§Ü§ã§ä?§å§ã§ä§â§à§Û§ã§ä§Ó§Ñ
							UpdateContext();
						} //if
					}
					else 
					{
						...
						case TAG_HLINE:
							...
							//RUS: §²§Ú§ã§à§Ó§Ñ§ß§Ú?§Ô§à§â§Ú§Ù§à§ß§ä§Ñ§Ý§î§ß§à§Û §Ý§Ú§ß§Ú?
							csTemp = m_defStyle;
						...
						case TAG_BITMAP:
							...
							//RUS: §±§Ñ§â§Ñ§Þ§Ö§ä§â?§á§à §å§Þ§à§Ý§é§Ñ§ß§Ú?
							si.nIdRes = 0;
							si.nIdDll = 0;
							si.nHandle = 0;
							si.nWidth = 100;
							...
							//RUS: §±§à§Ú§ã?§á§Ñ§â§Ñ§Þ§Ö§ä§â§à§Ó §Ú§Ù§à§Ò§â§Ñ§Ø§Ö§ß§Ú§ñ
							AnalyseImageParam(sProperties, si);
							
							//ENG: If a image's source was specified
							//RUS: §¦§ã§Ý§Ú §å§Ü§Ñ§Ù§Ñ§ß §Ú§ã§ä§à§é§ß§Ú§Ü §Ú§Ù§à§Ò§â§Ñ§Ø§Ö§ß§Ú§ñ
							if (si.nIdRes || si.nIdDll || si.nHandle || !si.strSrcFile.IsEmpty())
							{
								//ENG: Sets a autodelete flag of the image object
								//RUS: §µ§ã§ä§Ñ§ß§à§Ó§Ý§Ö§ß §æ§Ý§Ñ§Ô §Ñ§Ó§ä§à§Þ§Ñ§ä§Ú§é§Ö§ã§Ü§à§Ô?§å§Õ§Ñ§Ý§Ö§ß? §à§Ò§ì§Ö§Ü§ä?§Ú§Ù§à§Ò§â§Ñ§Ø§Ö§ß§Ú§ñ
								bAutoDelete = TRUE;
								
								//ENG: Gets a handle of the image
								//RUS: §±§à§Ý§å§é§Ú§ä§î §Õ§Ö§ã§Ü§â§Ú§á§ä§à§â §Ú§Ù§à§Ò§â§Ñ§Ø§Ö§ß§Ú§ñ
								if (si.nIdRes)
								...
								else if (si.nHandle)
								{
									...
									//RUS: §¦§ã§Ý§Ú §å§Ü§Ñ§Ù§Ñ§ß §Õ§Ö§ã§Ü§â§Ú§á§ä§à§â §Ú§Ù§à§Ò§â§Ñ§Ø§Ö§ß§Ú§ñ, §ä§à §Ù§Ñ§á§â§Ö§ë§Ñ§Ö?§å§Õ§Ñ§Ý§Ö§ß§Ú§Ö
									bAutoDelete = FALSE;
								} //if
								
								//ENG: If a handle of an image was retrieved
								//RUS: §¦§ã§Ý§Ú §Õ§Ö§ã§Ü§â§Ú§á§ä§à§â §Ú§Ù§à§Ò§â§Ñ§Ø§Ö§ß§Ú§ñ §á§à§Ý§å§é§Ö?
								if (NULL != hBitmap)
								{
									//ENG: Image with shadow or not?
									//RUS: §ª§Ù§à§Ò§â§Ñ§Ø§Ö§ß§Ú??§ä§Ö§ß§î?§Ú§Ý?§ß§Ö?
									bShadow = IsImageWithShadow(si);
									
									//ENG: Retrieves an original size of an image
									//RUS: §±§à§Ý§å§é§Ñ§Ö§Þ §à§â§Ú§Ô§Ú§ß§Ñ§Ý§î§ß§í§Û §â§Ñ§Ù§Þ§Ö§â §Ú§Ù§à§Ò§â§Ñ§Ø§Ö§ß§Ú§ñ
									m_drawmanager.GetSizeOfBitmap(hBitmap, &sz);
									
									//ENG: Retrieves an output size
									//RUS: §±§à§Ý§å§é§Ñ§Ö§Þ §â§Ñ§Ù§Þ§Ö§â?§Õ§Ý§ñ §â§Ú§ã§à§Ó§Ñ§ß§Ú§ñ
									...
									//RUS: §¦§ã§Ý§Ú §ä§Ö§ß§î §Õ§à§ã§ä§å§á§ß§Ñ, §ä§à §å§ã§ä§Ñ§ß§Ñ§Ó§Ý§Ú§Ó§Ñ§Ö?§â§Ö§Ñ§Ý§î§ß§í§Û §â§Ñ§Ù§Þ§Ö§â
									...
									//RUS: §©§Ñ§á§à§Þ§Ú§ß§Ñ§Ö§Þ §á§à§ã§Ý§Ö§Õ§ß§Ö?§Ô§à§â§Ú§Ù§à§ß§ä§Ñ§Ý§î§ß§à§Ö §Ó§í§â§Ñ§Ó§ß§Ú§Ó§Ñ§ß§Ú§Ö
									if (MODE_FIRSTPASS == m_nNumPass) 
										m_hline.nHorzAlign = m_defStyle.nHorzAlign;
									
									//ENG: Retrieves a vertical coordinates of drawing area
									//RUS: §±§à§Ý§å§é§Ñ§Ö§Þ §Ó§Ö§â§ä§Ú§Ü§Ñ§Ý§î§ß§å§ð §Ü§à§à§â§Õ§Ú§ß§Ñ§ä§å §à§Ò§Ý§Ñ§ã§ä?§â§Ú§ã§à§Ó§Ñ§ß§Ú§ñ
									y = VerticalAlignImage(ptOutput.y, si.nHeight);
									
									//ENG: If an image is exist and not prepare mode
									//RUS: §¦§ã§Ý§Ú §Ú§Ù§à§Ò§â§Ñ§Ø§Ö§ß§Ú?§Õ§à§ã§ä§å§á§ß§à ?§ß§Ö §å§ã§ä§Ñ§ß§à§Ó§Ý§Ö§ß §â§Ö§Ø§Ú?§á§à§Õ§Ô§à§ä§à§Ó§Ü§Ú
									if (si.nWidth && si.nHeight && (MODE_DRAW == m_nNumPass))
									{
										//ENG: Add an output area to hyperlink list if needed
										//RUS: §¦§ã§Ý§Ú §ß§Ö§à§Ò§ç§à§Õ§Ú§Þ§à §Õ§à§Ò§Ñ§Ó§Ý§ñ§Ö§Þ §à§Ò§Ý§Ñ§ã§ä?§Ó§í§Ó§à§Õ§Ñ ?§ã§á§Ú§ã§à§Ü §Ô§Ú§á§Ö§â§ã§ã§í§Ý§à?
										StoreHyperlinkArea(ptOutput.x, y, ptOutput.x + sz.cx, y + sz.cy);
										
										//ENG: If a mouse over an image then applies a hot styles
										//RUS: §¦§ã§Ý§Ú §Þ§í§ê§î §ß§Ñ?§Ú§Ù§à§Ò§â§Ñ§Ø§Ö§ß§Ú§Ö§Þ, §ä§à §á§â§Ú§Þ§Ö§ß§ñ§Ö§Þ §ã§à§à§ä§Ó§Ö§ã§ä§Ó§å§ð§ë§Ú§Ö §ã§ä§Ú§Ý?
										...
										//RUS: §²§Ú§ã§à§Ó§Ñ§ß§Ú?§Ú§Ù§à§Ò§â§Ñ§Ø§Ö§ß§Ú§ñ
									...
									//RUS: §±§Ö§â§Ö§Þ§Ö§ë§Ñ§Ö§Þ? §ã§á§â§Ñ§Ó§Ñ §à§ä §Ó§í§Ó§Ö§Õ§Ö§ß§ß§à§Ô?§Ú§Ù§à§Ò§â§Ñ§Ø§Ö§ß§Ú§ñ
									ptOutput.x += sz.cx; //si.nWidth;
									
									//ENG: If needed delete a handle of an image
									//RUS: §¦§ã§Ý§Ú §ß§Ö§à§Ò§ç§à§Õ§Ú§Þ§à §å§Õ§Ñ§Ý§ñ§Ö§Þ §Õ§Ö§ã§Ü§â§Ú§á§ä§à§â §Ú§Ù§à§Ò§â§Ñ§Ø§Ö§ß§Ú§ñ
									if (bAutoDelete)
						...
						case TAG_ICON:
							...
							if (si.nIdRes || si.nIdDll || si.nHandle || !si.strSrcFile.IsEmpty())
							{
								...
								//RUS: §±§à§Ý§å§é§Ñ§Ö§Þ §ä§â§Ö§Ò§å§Ö§Þ§í?§â§Ñ§Ù§Þ§Ö§â §Ú§Ü§à§ß§Ü§Ú
								sz.cx = si.nWidth;
								sz.cy = si.nHeight;
						...
						case TAG_IMAGELIST:
							...
							if (si.nIdRes || si.nIdDll || si.nHandle || !si.strSrcFile.IsEmpty())
							{
								...
								if (NULL != hBitmap)
								{
									...
									//RUS: §³§à§Ù§Õ§Ñ§Ö?§ß§Ö§Ù§Ñ§Õ§Ñ§ß§ß§í§Ö §â§Ñ§Ù§Þ§Ö§â?
									if (!si.cx && !si.cy)
									...
									//RUS: §±§à§Ý§å§é§Ñ§Ö§Þ §Þ§Ñ§Ü§ã§Ú§Þ§Ñ§Ý§î§ß§à§Ö §é§Ú§ã§Ý?§Ü§à§Ý§à§ß§à??§ã§ä§â§à?§Ú§Ù§à§Ò§â§Ñ§Ø§Ö§ß§Ú?§ß§Ñ §Ò§Ú§ä§Þ§Ñ§á§Ü§Ö
									nMaxCol = sz.cx / si.cx;
									nMaxRow = sz.cy / si.cy;
									...
									//RUS: §¦§ã§Ý§Ú §å§Ü§Ñ§Ù§Ñ§ß§ß§í?§Ú§ß§Õ§Ö§Ü§ã §Ú§Ù§à§Ò§â§Ñ§Ø§Ö§ß§Ú§ñ §Õ§à§á§å§ã§ä§Ú§Þ
...
int CPPHtmlDrawer::VerticalAlignText(int y, int nHeight)
{
	...
	if (MODE_FIRSTPASS == m_nNumPass)
	{
		...
		m_hline.nHeightLine = max(m_hline.nHeightLine, m_tm.tmAscent) + 3;
	}
	else if (MODE_DRAW == m_nNumPass)
	{
		switch (m_defStyle.nVertAlign)
...
int CPPHtmlDrawer::InitNewLine(int x)
{
	if (MODE_FIRSTPASS == m_nNumPass)
	{
		...
		//RUS: §³§à§Ù§Õ§Ñ§ß§Ú§Ö §ß§à§Ó§à?§Ý§Ú§ß§Ú??§á§Ñ§â§Ñ§Þ§Ö§ä§â§Ñ§Þ?§á§à-§å§Þ§à§Ý§é§Ñ§ß§Ú?
	...
	else if (MODE_DRAW == m_nNumPass)
	{
		...
		//RUS: §±§à§Ý§å§é§Ñ§Ö§Þ §Õ§Ñ§ß§ß§í§Ö §á§Ö§â§Ó§à§Û §ã§ä§â§à§Ü§Ú ?§á§â§Ö§à§Ò§â§Ñ§Ù§å§Ö?§á§â§à§è§Ö§ß§ä§ß§å§ð §ê§Ú§â§Ú§ß§å ?§â§Ö§Ñ§Ý§î§ß§å§ð
		...
		//RUS: §¬§à§à§â§Õ§Ú§ß§Ñ§ä§Ñ §ß§Ñ§é§Ñ§Ý§Ñ §Ó§í§Ó§à§Õ§Ñ ?§å§é§Ö§ä§à§Þ §Ó§í§â§Ñ§Ó§ß§Ú§Ó§Ñ§ß?
...
void CPPHtmlDrawer::Draw(HDC hDC, LPCTSTR lpszHtml, LPPOINT lpPoint)
{
	...
	//RUS: §±§à§Õ§Ô§à§ä§à§Ó§Ü§Ñ §ä§Ö§Ü§ã§ä§Ñ ?§Ó§í§Ó§à§Õ§å
	SIZE size;
	PrepareOutput(hDC, lpszHtml, &size);

	//ENG: If output was disabled
	//RUS: §¦§ã§Ý§Ú §Ó§í§Ó§à?§Ù§Ñ§á§â§Ö§ë§Ö§ß
	if (!size.cx || !size.cy)
		return;
	
	//ENG: Calculates an output area
	//RUS: §±§à§Õ§ã§é§Ö?§à§Ò§Ý§Ñ§ã§ä?§Ó§í§Ó§à§Õ§Ñ
	RECT rect;
	rect.left = lpPoint->x;
	rect.top = lpPoint->y;
	...
	//RUS: §£§í§Ó§à?§á§à§Õ§Ô§à§ä§à§Ó§Ý§Ö§ß§ß§à§Ô?§ä§Ö§Ü§ã§ä§Ñ
...
void CPPHtmlDrawer::PrepareOutput(HDC hDC, LPCTSTR lpszHtml, LPSIZE lpSize)
{
	...
	//RUS: §¬§à§á§Ú§â§à§Ó§Ñ§ß§Ú?§ß§Ñ§é§Ñ§Ý§î§ß§í?§á§Ñ§â§Ñ§Þ§Ö§ä§â§à§Ó
	m_hDC = hDC;
...
//	if (m_bIsTextWrapEnabled)
	...
	//RUS: §¦§ã§Ý§Ú §á§à§Õ§Ô§à§ä§à§Ó§Ý§Ö§ß§ß§í§Û §ä§Ö§Ü§ã?§ß§Ö §á§å§ã§ä§à§Û, §ä§à §Ó§í§ç§à?
	if (!m_csHtmlText.IsEmpty())
	{
		//ENG: Sets a prepare mode
		//RUS: §µ§ã§ä§Ñ§ß§Ñ§Ó§Ý§Ú§Ó§Ñ§Ö?§â§Ö§Ø§Ú?§á§à§Õ§Ô§à§ä§à§Ó§Ü§Ú
		m_nNumPass = MODE_FIRSTPASS;

		m_arrTables.clear();

		//ENG: Prepares to real output
		//RUS: §±§à§Õ§Ô§à§ä§à§Ó§Ü§Ñ ?§â§Ö§Ñ§Ý§î§ß§à§Þ?§Ó§í§Ó§à§Õ§å
...
void CPPHtmlDrawer::DrawPreparedOutput(HDC hDC, LPCRECT lpRect)
{
	...
	//RUS: §¦§ã§Ý§Ú §á§à§Õ§Ô§à§ä§à§Ó§Ý§Ö§ß§ß§í§Û §ä§Ö§Ü§ã?§á§å§ã§ä§à§Û, §ä§à §Ó§í§ç§à?
	if (m_csHtmlText.IsEmpty())
		return;
	...
	//RUS: §µ§ã§ä§Ñ§ß§Ñ§Ó§Ý§Ú§Ó§Ñ§Ö?§â§Ö§Ø§Ú?§Ó§í§Ó§à§Õ§Ñ
...
//		rect.right = rect.left + m_nMaxWidth;
	...
	//RUS: §£§í§Ó§à?§á§à§Õ§Ô§à§ä§à§Ó§Ý§Ö§ß§ß§à§Û §ã§ä§â§à§Ü§Ú
	DrawHtml(&size, &rect);
...
void CPPHtmlDrawer::SetImageList(HBITMAP hBitmap, int cx, int cy, int nCount, COLORREF crMask /* = RGB(255, 0, 255) */)
{
	...
	//RUS: §µ§Õ§Ñ§Ý§ñ§Ö§Þ §á§â§Ö§Õ§í§Õ§å§ë§Ú§Û §ã§á§Ú§ã§à§Ü §Ú§Ù§à§Ò§â§Ñ§Ø§Ö§ß§Ú?
	if (NULL != m_hImageList)
		::DeleteObject(m_hImageList);

	//ENG: If don't need to create a new image list
	//RUS: §¦§ã§Ý§Ú §ß§Ö §ß§å§Ø§ß?§ã§à§Ù§Õ§Ñ§Ó§Ñ§ä?§ß§à§Ó§í?§ã§á§Ú§ã§à§Ü §Ú§Ù§à§Ò§â§Ñ§Ø§Ö§ß§Ú?
	if (NULL == hBitmap)
		return;
...
{
	CPPString str = _T("");
	str += _T("body {font-size: 14pt; color:black; font-family:Î¢ÈíÑÅºÚ; line-height:18px;  }\r\n");
	str += _T("p {font-size: 10pt; color:black; font-family:Î¢ÈíÑÅºÚ; font-weight:bold}\r\n");
	str += _T("h1 {font-size: 14pt; color:black; font-family:Î¢ÈíÑÅºÚ; font-weight:bold}\r\n");
	str += _T("h2 {font-size: 13pt; color:#ff9900; font-family:Î¢ÈíÑÅºÚ; font-weight:bold}\r\n");
	str += _T("h3 {font-size: 12pt; color:#ff9900; font-family:Arial; font-weight:bold}\r\n");
	str += _T("h4 {font-size: 10pt; color:black; font-family:Î¢ÈíÑÅºÚ; font-weight:bold}\r\n");
	str += _T("h5 {font-size: 9pt; color:#ff9900; font-family:Î¢ÈíÑÅºÚ; font-weight:bold}\r\n");
	str += _T("h6 {font-size: 65%; color:#626262; font-family:Î¢ÈíÑÅºÚ; font-weight:normal}\r\n");
...
void CPPHtmlDrawer::SetDefaultStyles(_STRUCT_CHANGESTYLE & cs)
{
	...
	//Margins
	m_defStyle.nMargin = 10;
	
	//Padding
	m_defStyle.nPadding = 10;
...
CPPString CPPHtmlDrawer::GetTagBody(CPPString & str, int & nIndex)
{
	...
	//RUS: §ª§ë§Ö§Þ §à§Ü§à§ß§é§Ñ§ß§Ú?§ä§ï§Ô§Ñ
	int nEndOfTag = str.Find(_T('>'), nIndex);
	//ENG: The tag's end was found. Passes a tag's begin char ('<')
	//RUS: §¬§à§ß§Ö?§ä§ï§Ô§Ñ §ß§Ñ§Û§Õ§Ö§ß?§±§â§à§á§å§ã§Ü§Ñ§Ö§Þ §ã§Ú§Þ§Ó§à§Ý §ß§Ñ§é§Ñ§Ý§Ñ §ä§ï§Ô§Ñ
	nIndex++;
	if (nEndOfTag > nIndex)
	{
		//ENG: Gets a full body of tag
		//RUS: §±§à§Ý§å§é§Ñ§Ö§Þ §á§à§Ý§ß§å§ð §ã§ä§â§à§Ü§å §ä§ï§Ô§Ñ
		sTagName = str.Mid(nIndex, nEndOfTag - nIndex);
		//ENG: Jump to next char after the tag
		//RUS: §±§Ö§â§Ö§Þ§Ö§ë§Ñ§Ö§Þ? §ß§Ñ §ã§Ý§Ö§Õ§å§ð§ë§Ú?§Ù§Ñ §ä§ï§Ô§à?§ã§Ú§Þ§Ó§à§Ý
		nIndex = nEndOfTag + 1;
	} //if
	return sTagName;
} //End of GetTagBody
...
CPPString CPPHtmlDrawer::SplitTag(CPPString & sTag)
{
	...
	if (tch != _T('\0'))
	{
		...
		//RUS: §²§Ñ§Ù§Õ§Ö§Ý§Ú§ä§Ö§Ý?§ß§Ñ§Û§Õ§Ö§ß. §²§Ñ§Ù§Õ§Ö§Ý§ñ§Ö§Þ §ä§Ö§Ý§à §ä§ï§Ô§Ñ §ß§Ñ §Ú§Þ§ñ ?§á§Ñ§â§Ñ§Þ§Ö§ä§â?
...
SIZE CPPHtmlDrawer::GetTableDimensions(CPPString & sTable)
{
	...
	//RUS: §²§Ñ§Ù§Þ§Ö§â?§ä§Ñ§Ò§Ý§Ú§è?§á§à §å§Þ§à§Ý§é§Ñ§ß§Ú?
	SIZE szTable = {0, 0};
	int nIndex = 0;
	int nCol = 0;
	while (nIndex < sTable.GetLength())
	{
		...
		//RUS: §ª§ë§Ö§Þ §ß§Ñ§é§Ñ§Ý§à §ã§ä§â§à§Ü§Ú
		if (SearchTag(sTable, nIndex, _T("tr")))
		{
			//ENG: Increment count of the rows
			//RUS: §µ§Ó§Ö§Ý§Ú§é§Ú§Ó§Ñ§Ö?§Ü§à§Ý§Ú§é§Ö§ã§ä§Ó§à §ã§ä§â§à?
			szTable.cy++;

			//ENG: Count of the columns in current row
			//RUS: §¬§à§Ý§Ú§é§Ö§ã§ä§Ó§à §Ü§à§Ý§à§ß§à??§ä§Ö§Ü§å§ë§Ö?§ã§ä§â§à§Ü§Ö
			nCol = 0;
			int nEndRow;
			int nNewCell;
			do 
			{
				...
				//RUS: §ª§ë§Ö§Þ §Ü§à§ß§Ö?§ã§ä§â§à§Ü§Ú §Ú§Ý?§ß§Ñ§é§Ñ§Ý§à §ñ§é§Ö§Û§Ü?
				...
				if (nNewCell < nEndRow)
				{
					...
					//RUS: §µ§Ó§Ö§Ý§Ú§é§Ú§Ó§Ñ§Ö?§Ü§à§Ý§Ú§é§Ö§ã§ä§Ó§à §ñ§é§Ö§Ö§Ü ?§ã§ä§â§à§Ü§Ö
					nCol += szSpan.cx;

					//ENG: Jump to end of the cell
					//RUS: §±§Ö§â§Ö§ç§à§Õ§Ú?§ß§Ñ §Ü§à§ß§Ö?§ñ§é§Ö§Û§Ü?
...
SIZE CPPHtmlDrawer::AnalyseCellParam(CPPString & sProperties, _STRUCT_CHANGESTYLE & cs, BOOL bTable)
{
	...
	while (i < sProperties.GetLength())
	{
		...
		//RUS: §°§Ò§â§Ñ§Ò§Ñ§ä§í§Ó§Ñ§Ö§Þ §ã§á§Ö§è§Ú§æ§Ú§é§Ö§ã§Ü§Ú?§Õ§Ý§ñ §ä§ï§Ô§Ñ <table> §á§Ñ§â§Ñ§Þ§Ö§ä§â?
		if(bTable)
		{
	...
	//ENG: 
	//RUS: §¥§Ý§ñ §ñ§é§Ö§Ö§Ü §ê§Ú§â§Ú§ß§Ñ §Ó§ã§Ö§Ô§Õ§Ñ §â§Ñ§Ó§ß?1
...
CPPString CPPHtmlDrawer::GetWordWrap(CPPString & str, int nMaxSize, int & nRealSize)
{
	...
	if (0 == nLastIndex)
	{
		...
		{
			//RUS: §²§Ñ§Ù§â§í§Ó§à§Ó ?§ã§ä§â§à§Ü§Ö §ß§Ö §à§Ò§ß§Ñ§â§å§Ø§Ö§ß§à, §á§à§ï§ä§à§Þ?§Ò§å§Õ§Ö?§â§Ñ§Ù§Ò§Ú§Ó§Ñ§ä?§ã§ä§â§à§Ü§å 
			//     §á§à §ã§Ú§Þ§Ó§à§Ý§Ñ§Þ, ?§ß§Ö §á§à §ã§Ý§à§Ó§Ñ§Þ
			sz.cx = 0;
			...
			//RUS: §¯§Ö§Ó§à§Ù§Þ§à§Ø§ß§à §â§Ñ§Ù§Ò§Ú§ä?§ã§ä§â§à§Ü§å, §Ó§í§Ó§à§Õ§Ú?§è§Ö§Ý§Ú§Ü§à?
			sResult = str;
			str.Empty();
		}
		else
		{
			//RUS: ?§à§ä§ã§ä§Ñ§Ó§ê§Ö§Ö§ã§ñ §Þ§Ö§ã§ä?§ä§Ö§Ü§å§ë§Ö?§ã§ä§â§à§Ü§Ú §ß§Ö §Ó§Ý§Ñ§Ù§Ú§ä §ß§Ú §à§Õ§ß§à§Ô§à §ã§Ý§à§Ó?
			sz.cx = 0;
		} //if
	}
	else 
