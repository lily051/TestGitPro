...
//RUS: §©§Ñ§Ü§à§Þ§Ö§ß§ä§Ú§â§å§Û§ä§Ö §ã§Ý§Ö§Õ§å§ð§ë§å?§ã§ä§â§à§Ü§å, §Ö§ã§Ý§Ú §Ó§í §ß§Ö §á§Ý§Ñ§ß§Ú§â§å§Ö§ä§Ö §Ú§ã§á§à§Ý§î§Ù§à§Ó§Ñ§ä§î §ä§å§Ý§ä§Ú§á §Õ§Ý§ñ §ï§Ý§Ö§Þ§Ö§ß§ä§à?§Þ§Ö§ß§ð
...
//RUS: §£§í§â§Ñ§Ó§ß§Ú§Ó§Ñ§ß§Ú§Ö §Ü§à§ß§é§Ú§Ü?§ä§å§Ý§ä§Ú§á?§à§ä§ß§à§ã§Ú§ä§Ö§Ý§î§ß§à §ï§Ý§Ö§Þ§Ö§ß§ä§Ñ §Þ§Ö§ß§ð
...
// Construction
public:
	BOOL Create(CWnd* pParentWnd, BOOL bBalloon = FALSE);
...
public:
	...
	void AddTool(CWnd * pWnd, DWORD dwIdString, DWORD dwIdIcon, CSize & szIcon, LPCRECT lpRectBounds = NULL, DWORD dwIDTool = 0);
	void AddTool(CWnd * pWnd, LPCTSTR lpszString, HICON hIcon, LPCRECT lpRectBounds = NULL, DWORD dwIDTool = 0);
	void AddTool(CWnd * pWnd, LPCTSTR lpszString, DWORD dwIdIcon, CSize & szIcon, LPCRECT lpRectBounds = NULL, DWORD dwIDTool = 0);
	void AddTool(CWnd * pWnd, LPCTSTR lpszString, DWORD dwIdBitmap, COLORREF crMask, CSize & szBitmap, LPCRECT lpRectBounds = NULL, DWORD dwIDTool = 0);
	...
	void ShowHelpTooltip (LPPOINT pt, DWORD dwIdText, DWORD dwIdIcon, CSize & szIcon);
	void ShowHelpTooltip (LPPOINT pt, LPCTSTR lpszString, HICON hIcon = NULL);
	void ShowHelpTooltip (LPPOINT pt, LPCTSTR lpszString, DWORD dwIdIcon, CSize & szIcon);
	...
	void SetDirection (DWORD dwDirection = PPTOOLTIP_TOPEDGE_LEFT);
	DWORD GetDirection();
